...
if $no_d405; then
    launch_command="ros2 launch stretch_ros2_bridge server_no_d405.launch.py robot:=segway_rmp110"
else
    launch_command="ros2 launch stretch_ros2_bridge server.launch.py robot:=segway_rmp110"
fi
...
run_docker_command run -it --rm \
    ...
    -v /home/$USER/colcon_ws/src/stretch_segway_adapter:/home/hello-robot/colcon_ws/src/stretch_segway_adapter \
    -v /home/$USER/colcon_ws/install/stretch_segway_adapter:/home/hello-robot/colcon_ws/install/stretch_segway_adapter \
    -e HELLO_FLEET_ID=SEGWAY001 \
    -e PYTHONUNBUFFERED=1 \
    hellorobotinc/stretch-ai-ros2-bridge:$VERSION \
    /home/hello-robot/stretch_user/SEGWAY001/startup.sh
